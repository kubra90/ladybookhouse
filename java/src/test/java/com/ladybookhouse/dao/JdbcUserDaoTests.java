...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1, "user1", "user1","user1@gmail.com","000090", "ROLE_USER");
    protected static final User USER_2 = new User(2, "user2", "user2", "user2@gmail.com", "111111", "ROLE_USER");
    private static final User USER_3 = new User(3, "user3", "user3", "user3@gmail.com", "44444", "ROLE_USER");
